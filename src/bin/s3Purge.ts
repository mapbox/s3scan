...
console.log(figlet.textSync(`S3 Purge ${LIB_VERSION}`))

program
    .version(LIB_VERSION)
    .description(`A tool Provides a writable stream that expects you to write line-delimited S3 keys
    ...
    .option("-q, --quiet  [boolean]", "Boolean value to run in silent mode", false)
